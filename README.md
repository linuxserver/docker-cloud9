...
<!-- Please read the https://github.com/linuxserver/docker-cloud9/blob/ruby/.github/CONTRIBUTING.md -->
...
Simply pulling `lscr.io/linuxserver/cloud9:ruby` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  cloud9:
    image: lscr.io/linuxserver/cloud9:ruby
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/cloud9:ruby
```
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/cloud9:ruby`
...
* Update the image: `docker pull lscr.io/linuxserver/cloud9:ruby`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/cloud9:ruby .
```
